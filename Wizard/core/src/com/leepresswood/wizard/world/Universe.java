...
public class Universe
{
	...
	public Universe(ScreenGame screen)
	{
		...
		parallax_layers[1].sprite.translate(-5f, 7f);
		...
		parallax_layers[2].sprite.translate(19f, 3.5f);
		...
		parallax_layers[4].sprite.translate(-1f, 1f);
		...
		parallax_layers[5].sprite.translate(-1f, 1f);
	}
