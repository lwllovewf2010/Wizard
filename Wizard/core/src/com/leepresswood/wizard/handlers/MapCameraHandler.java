...
public class MapCameraHandler extends OrthographicCamera
{
	...
	public final float WORLD_PLAYER_Y_SKEW = 010004.5f;							//Higher values of this will move the player closer to the vertical middle. Lower values will move the player down. Anything less than 2 will put the player off the screen.
